...
\item Im Bereich humanmedizischer Forschung sin im speziellen \textcolor{linkblue}{\href{https://www.gesetze-im-internet.de/amg_1976/}{Arzneimittelgesetz (AMG)}} und \textcolor{linkblue}{\href{https://www.gesetze-im-internet.de/amg_1976/}{Medizinproduktgesetz (MPG)}} relevant.
\item Die Mehrheit der Leitlinien und Grundprinzipien haben ihren Ursprung in der Medizin, da ethische Fragestellungen in der klinischen Forschung mehr elaboriert sind.
\end{itemize}
\vfill
...
\item Aufklärung über das Recht, die Teilnahme an der Studie zu \textbf{verweigern} oder eine einmal gegebene Einwilligung \textbf{jederzeit} zu \textbf{widerrufen}, ohne dass ihr irgendwelche Nachteile entstehen.
...
\item Informierte Einwilligung zur Verwendung \textbf{identifizierbare menschliche Materialien oder Daten}.
\end{itemize}
...
\setstretch{1.4}
\begin{itemize} \justifying
\item \textbf{Registrierung} von Forschungshabenn in einer \textbf{öffentlich zugänglichen Datenbank} \textit{vor} der Rekrutierung der ersten Versuchsperson.
\item Verpfichtung von Forschenden, \textbf{Ergebnisse} ihrer Forschung am Menschen öffentlich verfügbar zu machen und Rechenschaftpflicht im Hinblick auf die Vollständigkeit und Richtigkeit ihrer Berichte.
...
\setstretch{1.3}
\begin{itemize} \justifying
\item Psycholog:innen streben stets danach, den Personen, mit denen sie arbeiten, \textbf{Nutzen und keinen Schaden} anzurichten, und deren Wohl und Rechte zu schützen.
\end{itemize}
...
\item Im Falle notwendiger Täschung, \textbf{Abwägung} ethischer Rechtfertigbarkeit, Berücksichtigung und \textbf{Verantwortungsübernahme} für alle möglichen \textbf{Konsequenzen}
\end{itemize}
...
\item \textbf{Rekruitierung}: Jede Maßnahme ist so zu gestalten, dass eine freie, unbeeinflusste Abwägnung, teilzunehmen oder nicht teilzunehmen möglich ist.
...
\item \textbf{Recht auf vorzeitiger Abbruch}: Teilnehmenden müssen zu jedem Zeitpunkt das Recht haben, eine Studie \textit{}{uneinschgeschränkt} (d.h. ohne, dass ihnen dadurch ein Nachteil entsteht) abzubrechen, \textit{und} darüber informiert sein.
\end{itemize}
...
\item Forscherin: Professorin und behandelt in ihrer Vor das Thema Träume 
\end{itemize}
...
* Die DGPs stellt \textcolor{linkblue}{\href{https://zwpd.transmit.de/zwpd-dienstleistungen/zwpd-ethikkommission/vorlagen-antragstellung}{Mustervorlagen}} für Allgemeine Informationen für Teilnehmer/-innen, sowie für spezifische Studien (z.B. für MRT-Studien, EEG-Studie)
...
\item Keine Täuschung bei Aspekten einer Forschungsarbeit mit erwartbaren ernsthafte physische und/oder psychische Belastungen.
\end{itemize}
...
\item ggf. besonderer Hinweis auf potenzielle physisiche Risiken in der Einwilligungserklärung (z.B. bei MRT-, TMS-, oder Gen-Studien).
\end{itemize}
...
\setstretch{1.3}
\begin{itemize} \footnotesize
\item Ehtikkommissionen verlangen stets die Einreichung zwei separater Unterlagen für Information und Einiwilligung, die jeweils den Teilnehmenden vorzulegen sind: Die \textit{Allgemeine Teilnehmerinformation} und die \textit{schriftliche Einwilligungserklärung}.
...
\item Erinnerung an Sitatuationen mit moralischer Schuld, Messung des Schuldgefühlserleben
...
\setstretch{1.2}
\begin{itemize} \justifying
\item Beachtung des \textcolor{linkblue}{\href{https://www.gesetze-im-internet.de/bdsg_2018/}{Datenschutz-Grundversordnung (Bundesdatenschutzgesetzes (BDSG))}} und \textcolor{linkblue}{\href{https://www.bmi.bund.de/SharedDocs/faqs/DE/themen/it-digitalpolitik/datenschutz/datenschutzgrundvo-liste.html}{Datenschutz-Grundversordnung (DSGVO)}}
...
\item Zeitlich versetzter Zugang zu Interventionen for Kontrollgruppen (''Warte-Kontroll-Gruppe'').
...
\item Zielführender und hilfreicher Nebeneffekt des Verfassens eines Ethik-Antrags ist die Strukturierung des Forschungsprojekts im Sinne wissenschaftlicher Standards.
\end{itemize}
...
\setstretch{1.3}
\begin{itemize} \justifying
\item Durch die Teilnahme entsteht kein Schaden oder Unbehagen, das über alltägliche Erfahrungen hinausgeht.
...
\item Ethische Prüfung von Forschungsvorhaben, insbesesondere Aufklärung und Einwilligung.
...
\setstretch{1.3}
\begin{itemize} \justifying \footnotesize
\item Die DGPs stellt Mustervorlagen für die \textit{Darstellung des Studienvorhabens} (unter \textcolor{linkblue}{\href{https://zwpd.transmit.de/zwpd-dienstleistungen/zwpd-ethikkommission/vorlagen-antragstellung}{Vorlage Ethikantrag}}) und \textcolor{linkblue}{\href{https://zwpd.transmit.de/images/zwpd/dienstleistungen/ethikkommission/hinweise_zum_ethikantrag_v13.pdf}{Hinweise zum Ethikantrag}}, sowie für die \textit{Teilnehmerinformation} und \textit{Einwilligungserklärung} zur Verfügung.
\item Auf der selben \textcolor{linkblue}{\href{https://zwpd.transmit.de/zwpd-dienstleistungen/zwpd-ethikkommission/vorlagen-antragstellung}{Website}} finden sich auch weitere Vorlagen für die Einwilligung von Bild- und Tonaufnahmen, Informationen zu EEG Studien, etc.
\end{itemize}
...
\item \text{Ethisch bedenklich}: Abraten von geplantem Vorhaben, Möglichkeit, revidierte Fassung einzureichen
\end{itemize}




# Ethikantrag Vorlagen===================================== {.plain}
\AtBeginSection{}
\section{Ethikantrag Vorlagen}
...
\begin{enumerate}
  ...
  \item Nennen Sie die wichtigsten Leitlinien für ethischen Handeln in psychologischer Praxis und Forschung.
  \item Nennen und erläutern Sie fünf ethische Grundsätze der Deklaration von Helsinki, welche Relevanz für die psychologische Forschung haben.
  \item Nennen Sie die Ethischen Grundprinzipien der APA.
  \item Nennen Sie die Ethischen Grundprinzipien der DGPs.
  \item Nennen und erläutern Sie die zentralen Aspekte des Prinzips "Respekt vor der Selbstbestimmung".
  \item Nennen Sie die zentralen Aspekte einer Teilnehmerinformation, sowie fwesentliche Inhalte.
...
\addtocounter{enumi}{10}
  ...
  \item Nennen Sie die zentralen Aspekte und formalen Mindestbestandteile eines Ethik-Antrags.
