...
# Ausgabe
cat("     Korrelation von General Advisement und BDI Change Index             : ",   round(rho,      digits = 3),
...
xlim    = c(2,8),
cex     = 1.2,
main    = TeX(sprintf("r = %.2f, SQE = %.2f, SQT = %.2f, $R^2=$ %.2f", rho, SQE, SQT, Rsquare)))
